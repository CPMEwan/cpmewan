...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan]{01}: 𝐈𝐧𝐜𝐫𝐞𝐚𝐬𝐞 𝐌𝐨𝐧𝐞𝐲           1.000K[/bold cyan]")
            console.print("[bold cyan]{02}: 𝐈𝐧𝐜𝐫𝐞𝐚𝐬𝐞 𝐂𝐨𝐢𝐧𝐬           3.500K[/bold cyan]")
            console.print("[bold cyan]{03}: 𝐊𝐢𝐧𝐠 𝐑𝐚𝐧𝐤                4.000K[/bold cyan]")
            console.print("[bold cyan]{04}: 𝐂𝐡𝐚𝐧𝐠𝐞 𝐈𝐃                3.500K[/bold cyan]")
            console.print("[bold cyan]{05}: 𝐂𝐡𝐚𝐧𝐠𝐞 𝐍𝐚𝐦𝐞              100[/bold cyan]")
            console.print("[bold cyan]{06}: 𝐂𝐡𝐚𝐧𝐠𝐞 𝐍𝐚𝐦𝐞 (𝐑𝐚𝐢𝐧𝐁𝐨𝐰)    100[/bold cyan]")
            console.print("[bold cyan]{07}: 𝐍𝐮𝐦𝐛𝐫𝐫 𝐏𝐥𝐚𝐭𝐞𝐬            2.000K[/bold cyan]")
            console.print("[bold cyan]{08}: 𝐀𝐜𝐜𝐨𝐮𝐧𝐭 𝐃𝐞𝐥𝐞𝐭𝐞           FREE[/bold cyan]")
            console.print("[bold cyan]{09}: 𝐀𝐜𝐜𝐨𝐮𝐧𝐭 𝐑𝐞𝐠𝐢𝐬𝐭𝐞𝐫         FREE[/bold cyan]")
            console.print("[bold cyan]{10}: 𝐃𝐞𝐥𝐞𝐭𝐞 𝐅𝐫𝐢𝐞𝐧𝐝𝐬           500[/bold cyan]")
            console.print("[bold cyan]{11}: 𝐔𝐧𝐥𝐨𝐜𝐤 𝐏𝐚𝐢𝐝 𝐂𝐚𝐫𝐬         4000K[/bold cyan]")
            console.print("[bold cyan]{12}: 𝐔𝐧𝐥𝐨𝐜𝐤 𝐀𝐥𝐥 𝐂𝐚𝐫𝐬          3.000K[/bold cyan]")
            console.print("[bold cyan]{13}: 𝐔𝐧𝐥𝐨𝐜𝐤 𝐀𝐥𝐥 𝐂𝐚𝐫𝐬 𝐒𝐢𝐫𝐞𝐧    2.000K[/bold cyan]")
            console.print("[bold cyan]{14}: 𝐔𝐧𝐥𝐨𝐜𝐤 𝐖16 𝐄𝐧𝐠𝐢𝐧𝐞        3.000K[/bold cyan]")
            console.print("[bold cyan]{15}: 𝐔𝐧𝐥𝐨𝐜𝐤 𝐀𝐥𝐥 𝐇𝐨𝐫𝐧𝐬         3.000K[/bold cyan]")
            console.print("[bold cyan]{16}: 𝐔𝐧𝐥𝐨𝐜𝐤 𝐃𝐢𝐬𝐚𝐛𝐥𝐞 𝐃𝐚𝐦𝐚𝐠𝐞    2.000K[/bold cyan]")
            console.print("[bold cyan]{17}: 𝐔𝐧𝐥𝐨𝐜𝐤 𝐔𝐧𝐥𝐢𝐦𝐢𝐭𝐞𝐝 𝐅𝐮𝐞𝐥    2.000K[/bold cyan]")
            console.print("[bold cyan]{18}: 𝐔𝐧𝐥𝐨𝐜𝐤 𝐇𝐨𝐮𝐬𝐞 3           3.500K[/bold cyan]")
            console.print("[bold cyan]{19}: 𝐔𝐧𝐥𝐨𝐜𝐤 𝐒𝐦𝐨𝐤𝐞             2.000K[/bold cyan]")
            console.print("[bold cyan]{20}: 𝐂𝐡𝐚𝐧𝐠𝐫 𝐑𝐚𝐜𝐞 𝐖𝐢𝐧𝐬         1.000K[/bold cyan]")
            console.print("[bold cyan]{21}: 𝐂𝐡𝐚𝐧𝐞 𝐑𝐚𝐜𝐞 𝐋𝐨𝐬𝐞𝐬        1.000K[/bold cyan]")
            console.print("[bold cyan]{22}: 𝐂𝐥𝐨𝐧𝐞 𝐀𝐜𝐜𝐨𝐮𝐧𝐭            5.000K[/bold cyan]")
            console.print("[bold cyan]{0} : 𝐄𝐱𝐢𝐭[/bold cyan]", end="\n\n")
