...
def load_key_data(cpm):
    ...
    console.print(f"[bold green] Your Access Key [/bold green]: {data.get('access_key')}.")
    
    console.print(f"[bold green] Your Telegram ID[/bold green]: {data.get('telegram_id')}.")
    
    console.print(f"[bold green] Your Balance $  [/bold green]: {(data.get('coins') if not data.get('is_unlimited') else 'Unlimited')}.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan]{01}: Increase Money[/bold cyan]           [bold red]1.000K[/bold red]")
            console.print("[bold cyan]{02}: Increase Coins[/bold cyan]           [bold red]3.500K[/bold red]")
            console.print("[bold cyan]{03}: King Rank[/bold cyan]                [bold red]4.000K[/bold red]")
            console.print("[bold cyan]{04}: Change ID[/bold cyan]                [bold red]3.500K[/bold red]")
            console.print("[bold cyan]{05}: Change Name[/bold cyan]              [bold red]100[/bold red]")
            console.print("[bold cyan]{06}: Change Name (Rainbow)[/bold cyan]    [bold red]100[/bold red]")
            console.print("[bold cyan]{07}: Number Plates[/bold cyan]            [bold red]2.000K[/bold red]")
            console.print("[bold cyan]{08}: Account Delete[/bold cyan]           [bold red]FREE[/bold red]")
            console.print("[bold cyan]{09}: Account Register[/bold cyan]         [bold red]FREE[/bold red]")
            console.print("[bold cyan]{10}: Delete Friends[/bold cyan]           [bold red]500[/bold red]")
            console.print("[bold cyan]{11}: Unlock Paid Cars[/bold cyan]         [bold red]4000K[/bold red]")
            console.print("[bold cyan]{12}: Unlock all Cars[/bold cyan]          [bold red]3.000K[/bold red]")
            console.print("[bold cyan]{13}: Unlock all Cars Siren[/bold cyan]    [bold red]2.000K[/bold red]")
            console.print("[bold cyan]{14}: Unlock w16 Engine[/bold cyan]        [bold red]3.000K[/bold red]")
            console.print("[bold cyan]{15}: Unlock All Horns[/bold cyan]         [bold red]3.000K[/bold red]")
            console.print("[bold cyan]{16}: Unlock Disable Damage[/bold cyan]    [bold red]2.000K[/bold red]")
            console.print("[bold cyan]{17}: Unlock Unlimited Fuel[/bold cyan]    [bold red]2.000K[/bold red]")
            console.print("[bold cyan]{18}: Unlock House 3[/bold cyan]           [bold red]3.500K[/bold red]")
            console.print("[bold cyan]{19}: Unlock Smoke[/bold cyan]             [bold red]2.000K[/bold red]")
            console.print("[bold cyan]{20}: Change Race Wins[/bold cyan]         [bold red]1.000K[/bold red]")
            console.print("[bold cyan]{21}: Change Race Loses[/bold cyan]        [bold red]1.000K[/bold red]")
            console.print("[bold cyan]{22}: Clone Account[/bold cyan]            [bold red]5.000K[/bold red]")
